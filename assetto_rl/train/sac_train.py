...
# Set to a checkpoint folder to resume, or None for a fresh run. Forward slashes are cross-platform.
RESUME_DIR = "models/SAC_after_straightening_20260226_064600/1760000_steps"
...
# --- Run name ---
RUN_NAME = "SAC_after_straightening_spa"
